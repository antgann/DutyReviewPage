...
//  header
  ...
  // Origin.rflag = 'A' before its accepted rflag 'H' 
  //
  ...
  $sql_query="SELECT t2.* from (
    SELECT /*+ FIRST_ROWS */ 
            ...
            c.ntid=t.ntid
            WHERE e.selectflag=1 and e.etype='st' and o.orid=e.prefor and
            o.datetime between $start and $stop and o.rflag = 'A'
...
//echo "$sql_query\n"; 
  ...
  echo "&nbsp;<a href=\"../trigger.php\" target=\"_top\">(refresh catalog)</a>"; 
  echo "<BR><BR><A HREF=\"../index.php\" TARGET=\"_top\">Event Review Page</A><BR>";
...
function selectDefaultEvid(scrollList) {
  ...
  // <buttons>
  action= "makeButtonPanelTrigger.php?EVID="+getCurrentId();
