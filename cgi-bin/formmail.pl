...
##############################################################################
#
# Removed some stuff from error and status messages
#
# NOTE: there is no specific Field for the body of the email message. It expects
# to just blurt all named fields into the email and send it. It always writes the
# "INPUT-name: value... " which is not what I want. 
# You get some control by using the 'print_config'  variables.
# I removed the ":" from the print statements so you could get an unnamed field
# to print without writing anything extra to the email message.
# Otherwise it wrote ": blah blah..." in the body of the message.
