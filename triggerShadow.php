...
<!-- This defines the frames for the Trigger Review Page
     The waves & buttons frames are event specific and created by catalogShadowTrigger.php  -->
...
<?php
    ...
    print "<title>SHADOW $networkCode Trigger Review</title>";
 ?>
  </head>
  <frameset rows="75%,*" style="margin:2">
   ...
   <frame src="cgi-bin/catalogShadowTrigger.php" name="catalog">
  </frameset>
</html>
